            ...
            <div className="boardingDetailsTexts">
              ...
              <div className="aligncont">
                ...
                <div className="rateButtonAlign">
                  <div>
                    <button className="ratebutton" onClick={openPopup}>
                      give your rate
                    </button>
                    {Popup ? (
                      <div>
                        <div className="backgrnd">
                          <div className="popup">
                            <h1 className="alignhdr" onClick={closePopup}>
                              X
                            </h1>
                  ...
                  <div>
                    <button className="ratebutton" onClick={clicked}>
                      comment here
                    </button>
                  </div>
                </div>
            ...
            {cilck ? (
              <div>
                <div className="commentbox">
                  ...
                  />
                  <button className="sbtn" onClick={setcomment}>
                    submit
                  </button>
                </div>
              </div>
