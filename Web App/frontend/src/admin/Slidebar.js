  ...
  return (
    <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" id="Slidebar">
      <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
        <span class="Header">Hi, ADMIN</span>
      </a>
      <br></br>
      <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li>
          <button href="#" onClick={handleSetting}  class="btn btn-outline-success d-inline-flex align-items-center" id="Slidebutton">
        ...
        <li>
          <button href="#" onClick={handleAdmission}  class="btn btn-outline-success d-inline-flex align-items-center" id="Slidebutton">
        ...
        <li>
          <button href="#" onClick={handleSignout}  class="btn btn-outline-success d-inline-flex align-items-center" id="Slidebutton">
      ...
      <hr></hr>
      <div class="dropdown">
        <img src="https://github.com/mdo.png" alt="" width="25%" height="80%" class="rounded-circle me-2"></img>
