  ...
  return (
    <div className="d-flex flex-column min-vh-100">
      ...
      <div className="mt-auto">
        <MDBFooter className="text-center text-white" style={{ backgroundColor: "#0d987d" }}>
          <div
          ...
          <div className="p-3">
            ...
            <p className="mb-0 text-white">{demoContactDetails}</p>

            {/* Demo Address */}
            <p className="text-white">{demoAddress}</p>
          </div>
