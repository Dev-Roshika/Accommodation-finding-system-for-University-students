...
function Signup() {
    ...
    const handleInput = (event) => {
        ...
        }if (event.target.position === "position") {
    ...
    useEffect(() => {
        if (email) {
            axios
                .get("http://localhost:8081/admin/check-email", {
                    params: { email: email },
                })
                .then((res) => {
    ...
    useEffect(() => {
        if (username) {
            axios
                .get("http://localhost:8081/admin/check-username", {
    ...
    const handleSubmit = async (event) => {
        ...
        if (emailExists === false && usernameExists === false) {
            ...
            axios
                .post("http://localhost:8081/admin/signup", formData)
                .then((res) => {
